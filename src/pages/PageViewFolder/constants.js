...
export const ACTION_START_UPLOAD_FILE = 'ACTION_START_UPLOAD_FILE'
export const ACTION_RETRY_UPLOAD_FILE = 'ACTION_RETRY_UPLOAD_FILE'
export const ACTION_REMOVE_UPLOAD_FILE = 'ACTION_REMOVE_UPLOAD_FILE'
export const ACTION_CLEAR_UPLOAD_LIST = 'ACTION_CLEAR_UPLOAD_LIST'
...
export const ACTION_COMPLETE_FILE_UPLOAD = 'ACTION_COMPLETE_FILE_UPLOAD'
...
export const ACTION_ACTIVATE_ITEM = 'ACTION_ACTIVATE_ITEM'
